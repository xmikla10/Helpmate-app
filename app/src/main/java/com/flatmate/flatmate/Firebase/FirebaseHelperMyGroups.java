...
public class FirebaseHelperMyGroups
{
    ...
    public FirebaseHelperMyGroups(DatabaseReference db) {
        this.db = db;
    }

    //READ
    public ArrayList<NewGroup> retrieve()
    {
        firebaseAuth = FirebaseAuth.getInstance();
        userID = firebaseAuth.getCurrentUser().getUid().toString();
        db.child("user").child("groups").child("user").child(userID).addChildEventListener(new ChildEventListener()
        {
